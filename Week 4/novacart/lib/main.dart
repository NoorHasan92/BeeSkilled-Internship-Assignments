...
class _HomeShellState extends State<HomeShell> {
  ...
  void initState() {
    super.initState();
    _notificationSub = NotificationService.instance.onNotificationTap.listen((orderId) {
      if (mounted) {
          ...
          NavigationDestination(
            icon: Consumer<CartProvider>(
              builder: (context, cart, child) {
                if (cart.totalItems == 0) return const Icon(Icons.shopping_bag_outlined);
                return Badge(
            ...
            selectedIcon: Consumer<CartProvider>(
              builder: (context, cart, child) {
                if (cart.totalItems == 0) return const Icon(Icons.shopping_bag_rounded);
                return Badge(
                  label: Text('${cart.totalItems}'),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(icon, color: const Color(0xFF635BFF), size: 28),
          const SizedBox(height: 8),
...
class _SearchPageState extends State<SearchPage> {
  ...
  final List<String> _categories = ['All', 'Tech', 'Fashion', 'Home', 'Lifestyle'];
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Text('Search products', style: theme.textTheme.headlineMedium?.copyWith(fontWeight: FontWeight.w900)),
          ),
          Padding(
          ...
          Expanded(
            child: StreamBuilder<List<Product>>(
              ...
              builder: (context, snapshot) {
                ...
                return _ProductGrid(products: filtered, onNavigate: widget.onNavigate);
              },
            ),
          ),
        ],
          ...
          return SafeArea(
            child: Center(
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  const Icon(Icons.shopping_bag_outlined, size: 80, color: Color(0xFF635BFF)),
                  const SizedBox(height: 24),
                  Text(
                    'Your cart is empty',
                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        Text('Subtotal', style: TextStyle(color: theme.colorScheme.onSurfaceVariant)),
                        Text('₹${cart.subtotal.toStringAsFixed(0)}', style: const TextStyle(fontWeight: FontWeight.w600)),
                      ],
                    ),
                    const SizedBox(height: 12),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text('Delivery', style: TextStyle(color: theme.colorScheme.onSurfaceVariant)),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text('₹${cart.subtotal.toStringAsFixed(0)}', style: const TextStyle(fontWeight: FontWeight.w900, fontSize: 22)),
                      ],
                    ),
                    const SizedBox(height: 24),
                    SizedBox(
        ...
        children: [
          Container(
            ...
            child: item.product.imageUrl.isEmpty
                ...
                : Image.network(item.product.imageUrl, fit: BoxFit.cover, errorBuilder: (c, e, s) => const Icon(Icons.broken_image_outlined)),
          ),
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Delivery Address', style: theme.textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
              const SizedBox(height: 16),
              TextFormField(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(item.product.name, maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontWeight: FontWeight.w600)),
                          Text('Qty: ${item.quantity}', style: TextStyle(color: theme.colorScheme.onSurfaceVariant)),
                        ],
                      ),
                    ),
              ...
              Row(
                ...
                children: [
                  ...
                  Text('₹${cart.subtotal.toStringAsFixed(0)}', style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w900)),
                ],
              ),
              const SizedBox(height: 32),
              SizedBox(
...
class _MockPaymentPageState extends State<MockPaymentPage> {
  ...
  Future<void> _processPayment() async {
    ...
    try {
      ...
      final orderId = 'NC-${DateTime.now().millisecondsSinceEpoch.toString().substring(5)}';
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Amount to Pay: ₹${widget.total.toStringAsFixed(0)}', 
              ...
              SizedBox(
                ...
                child: FilledButton(
                  ...
                  child: _isLoading 
                    ...
                    : Text('Pay ₹${widget.total.toStringAsFixed(0)}', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                ),
              ),
            ],
          ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                Text('Your order has been placed.', style: TextStyle(color: Theme.of(context).colorScheme.onSurfaceVariant, fontSize: 16)),
                const SizedBox(height: 8),
    ...
    return SafeArea(
      child: Column(
        ...
        children: [
          Padding(
            padding: const EdgeInsets.all(20),
            child: Text('Your Orders', style: Theme.of(context).textTheme.headlineMedium?.copyWith(fontWeight: FontWeight.w900)),
          ),
          Expanded(
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 16),
                        Text('Oops! Something went wrong', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
                        const SizedBox(height: 8),
                        Text('We could not load your orders.', style: TextStyle(color: Theme.of(context).colorScheme.onSurfaceVariant)),
                        const SizedBox(height: 24),
                        FilledButton.icon(
                          onPressed: () {
                            setState(() {
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 16),
                        Text('No orders yet', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
                        const SizedBox(height: 8),
                        Text('Your purchases will appear here.', style: TextStyle(color: Theme.of(context).colorScheme.onSurfaceVariant)),
                        const SizedBox(height: 24),
                        FilledButton(
                          onPressed: () {
                            if (widget.onStartShopping != null) widget.onStartShopping!();
                          },
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Text('₹${order.total.toStringAsFixed(0)}', style: TextStyle(fontWeight: FontWeight.w900, color: theme.colorScheme.primary, fontSize: 16)),
                ],
              ),
              const SizedBox(height: 4),
              if (order.createdAt != null)
                Text('${_getMonth(order.createdAt!.month)} ${order.createdAt!.day}, ${order.createdAt!.year}', style: TextStyle(color: theme.colorScheme.onSurfaceVariant)),
              const SizedBox(height: 16),
              Text('$itemCount item${itemCount == 1 ? '' : 's'}', style: const TextStyle(fontWeight: FontWeight.w600)),
              const SizedBox(height: 16),
              Row(
                children: [
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            color: order.paymentStatus == 'paid' ? Colors.green[700] : Colors.orange[800],
                            fontWeight: FontWeight.bold,
                            fontSize: 12,
                          ),
                        ),
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(order.orderId, style: theme.textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.bold)),
            if (order.createdAt != null)
              Padding(
                padding: const EdgeInsets.only(top: 8),
                child: Text('Placed on ${order.createdAt!.toLocal()}', style: TextStyle(color: theme.colorScheme.onSurfaceVariant)),
              ),
            const SizedBox(height: 24),
            ...
            const SizedBox(height: 12),
            Text(order.address.name, style: const TextStyle(fontWeight: FontWeight.w600)),
            ...
            Row(
              ...
              children: [
                const Text('Subtotal'),
                Text('₹${order.subtotal.toStringAsFixed(0)}', style: const TextStyle(fontWeight: FontWeight.w600)),
              ],
            ),
            const SizedBox(height: 8),
            const Row(
            ...
            Row(
              ...
              children: [
                const Text('Total', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                Text('₹${order.total.toStringAsFixed(0)}', style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w900)),
              ],
            ),
          ],
        ),
              ...
              children: [
                ...
                ListTile(
                  ...
                  trailing: Switch(
                    ...
                    onChanged: (val) {
                      // Prompt user or inform them to change settings
